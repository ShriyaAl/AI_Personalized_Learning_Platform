-- SQL Script to Reset Database
-- WARNING: This will DELETE all data in the specified tables!

-- 1. Drop existing tables if they exist (ordered by dependency)
...
DROP TABLE IF EXISTS "Posts" CASCADE; -- Dropping the old 'Posts' table seen in app.js

-- 2. Enable UUID extension (just in case)
CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- 3. Now run your schema.sql content...
-- (I will append the schema content below for easy one-click execution)
