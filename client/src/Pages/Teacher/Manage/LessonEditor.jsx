...
//         credentials: 'include'
//       });
//       if (res.ok) alert("CONTENT SYNCED TO DATABASE! 🚀");
//     } catch (err) {
...
//     if (!window.confirm("This will overwrite your current edits with new AI content. Proceed?")) return;
//     setIsSaving(true);
//     try {
...
//   if (loading) return <div className="p-20 font-black animate-pulse text-center">LOADING EDITOR...</div>;
...
//             <button onClick={() => navigate(-1)} className="font-black underline decoration-4 tracking-tighter hover:text-blue-600">← BACK TO ROADMAP</button>
//             <button 
//                 onClick={handleRegenerate}
//                 className="bg-black text-white px-6 py-2 rounded-xl font-black text-xs hover:bg-zinc-800 shadow-[4px_4px_0px_0px_#F3B8F8]"
//             >
...
//         <div className="mb-10">
//             <span className="bg-yellow-300 border-2 border-black px-3 py-1 rounded-lg text-xs font-black italic uppercase">Teacher Mode</span>
//             <h1 className="text-5xl font-black mb-2 italic uppercase tracking-tighter mt-2">{lesson.title}</h1>
//             <p className="text-gray-400 font-bold">Edit the explanation below. Changes reflect instantly for students.</p>
//         </div>
...
//             className="w-full h-[600px] border-[6px] border-black p-10 rounded-[50px] shadow-[15px_15px_0px_0px_black] outline-none text-xl leading-relaxed focus:bg-yellow-50 transition-all font-medium"
//             placeholder="No content yet. Click Re-generate or start typing..."
//           />
//           <div className="absolute top-6 right-10 text-[10px] font-black text-gray-300 uppercase tracking-widest">Pinnacle Content Engine</div>
//         </div>
...
//                 onClick={handleSave}
//                 disabled={isSaving}
//                 className="flex-1 bg-[#98EECC] border-[5px] border-black py-5 rounded-[25px] font-black text-2xl shadow-[8px_8px_0px_0px_black] active:translate-y-1 active:shadow-none transition-all uppercase italic"
//             >
